...
import { InjectDrizzle, storyStudioEndings } from "@superbuilder/features-db";
import type { DrizzleDB, NewStoryStudioEnding, StoryStudioCondition } from "@superbuilder/features-db";

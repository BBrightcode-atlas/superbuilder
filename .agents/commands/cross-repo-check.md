---
description: superbuilder, superbuilder-features, superbuilder-app-boilerplate 3개 repo 간 정합성 검증
allowed-tools: Bash, Read, Edit, Glob, Grep
---

3개 레포(`superbuilder`, `superbuilder-features`, `superbuilder-app-boilerplate`) 간의 정합성을 종합 검증한다.
...
| superbuilder-app-boilerplate | `~/Projects/superbuilder-app-boilerplate` |
...
### 소스 B: superbuilder-app-boilerplate
```bash
...
1. Repo 존재 확인
   ...
   [PASS] superbuilder-app-boilerplate — ~/Projects/superbuilder-app-boilerplate

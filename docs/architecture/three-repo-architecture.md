...
| **superbuilder-app-template** | `BBrightcode-atlas/superbuilder-app-template` | 앱 템플릿 — 빈 셸 + `[ATLAS:*]` 마커, superbuilder.json |
...
3. **superbuilder-app-template**: 최종 프로젝트의 **골격 템플릿**. `[ATLAS:*]` 마커가 있는 빈 셸로, scaffold 시 feature 코드가 주입된다.

```
superbuilder-features         superbuilder           superbuilder-app-template
...
### 2.3 superbuilder-app-template (`BBrightcode-atlas/superbuilder-app-template`)

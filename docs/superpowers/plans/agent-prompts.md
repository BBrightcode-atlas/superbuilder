...
- 다른 레포 (superbuilder-app-boilerplate, superbuilder/packages/atlas-engine)는 절대 수정하지 않을 것
...
| Task 16-19 | superbuilder-app-boilerplate | (루트) | main |
...
- Task 16-19: superbuilder-app-boilerplate/ 로 이동하여 작업 (마커 삽입)
...
3. superbuilder-app-boilerplate의 6개 파일에 [ATLAS:*] 마커 삽입
4. 통합 테스트 통과
